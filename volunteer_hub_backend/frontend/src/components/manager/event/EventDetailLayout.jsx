              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-full transition"
                  >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-white/80 text-sm">
                  ...
                  <span className="inline-flex items-center gap-2">
                    ...
                    {(event.volunteers?.length || 0)}/{event.volunteersNeeded || 0} tình nguyện viên
                  </span>
                </div>
              </div>
