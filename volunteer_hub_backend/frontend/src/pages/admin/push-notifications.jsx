...
export default function AdminPushNotificationDashboard() {
    ...
    const roles = [
        { id: "VOLUNTEER", label: "Volunteer", icon: "👤", description: "Tình nguyện viên" },
        { id: "MANAGER", label: "Manager", icon: "👔", description: "Quản lý sự kiện" },
        { id: "ADMIN", label: "Admin", icon: "🛡️", description: "Quản trị viên" }
    ];
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-500 mt-2">
                            Gửi thông báo Web Push đến tất cả người dùng trong hệ thống.
                        </p>
                    </div>
                        ...
                        <Card className="border-blue-100 shadow-md">
                            <CardHeader className="bg-gradient-to-r from-blue-50 to-white pb-6">
                                <CardTitle className="text-blue-900 flex items-center gap-2">
                                    <Bell className="h-5 w-5" /> Soạn thông báo hệ thống
                                </CardTitle>
                                <CardDescription>Gửi thông báo đến thiết bị người dùng (Web Push)</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 pt-6">
                                ...
                                <div className="space-y-4 pt-2">
                                    ...
                                    >
                                        <div className={`flex items-center space-x-2 rounded-lg border p-4 cursor-pointer transition-all ${targetType === 'all' ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'}`}>
                                            <RadioGroupItem value="all" id="all" />
                                            <Label htmlFor="all" className="cursor-pointer font-medium">Tất cả người dùng</Label>
                                        </div>
                                        <div className={`flex items-center space-x-2 rounded-lg border p-4 cursor-pointer transition-all ${targetType === 'role' ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'}`}>
                                            <RadioGroupItem value="role" id="role" />
                                            <Label htmlFor="role" className="cursor-pointer font-medium">Theo vai trò</Label>
                                        </div>
                                        <div className={`flex items-center space-x-2 rounded-lg border p-4 cursor-pointer transition-all ${targetType === 'specific' ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'}`}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            {roles.map(role => (
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <div>
                                                        <Label htmlFor={`role-${role.id}`} className="font-medium cursor-pointer flex items-center gap-2">
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-3">
                                                {selectedUsers.map(user => (
                                                    <Badge 
                                                        key={user.userId} 
                                                        variant="secondary" 
                                                        className="flex items-center gap-1 px-3 py-1.5 bg-blue-100 text-blue-800 hover:bg-blue-200"
                                                    >
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="bg-blue-50 border-blue-100">
                            <CardContent className="p-4 flex gap-3 text-sm text-blue-800">
                                ...
                                <div>
                                    <p className="font-medium mb-1">Admin Push Notification</p>
                                    <p className="text-xs text-blue-700">
                                        Bạn có thể gửi thông báo đến tất cả người dùng trong hệ thống bao gồm Volunteer, Manager và Admin.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
