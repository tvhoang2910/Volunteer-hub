...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle type mismatch errors (e.g., invalid UUID format in path variable)
     */
    ...
    public ResponseEntity<ResponseDTO<Void>> handleTypeMismatch(
        ...
        String detail = String.format("Parameter '%s' with value '%s' is not a valid %s",
                paramName, invalidValue, expectedType);

        logger.warn("Type mismatch for {} {}: {}",
    ...
    public ResponseEntity<ResponseDTO<Void>> handleHttpMessageNotReadable(
        ...
        logger.warn("JSON parsing error for {} {} from IP {}: {}",
                request.getMethod(), request.getRequestURI(), getClientIP(request), detail);
