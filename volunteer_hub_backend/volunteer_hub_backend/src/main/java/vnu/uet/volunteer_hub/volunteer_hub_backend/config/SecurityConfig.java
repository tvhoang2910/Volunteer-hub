        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(authz -> {
                                        var registry = authz
                                                        // Auth endpoints that require authentication - must be before
                                                        // permitAll
                                        ...
                                        if (enableBootstrapAdmin && environment.acceptsProfiles(Profiles.of("dev"))) {
                                                registry.requestMatchers(HttpMethod.POST, "/api/dev/bootstrap-admin")
                                                                .permitAll();
                                        }
                                        ...
                                        registry
                                                        ...
                                                        // Tất cả các request khác cần authenticated (bao gồm POST
                                                        // /api/posts)
