...
public class NotificationAPI {
        ...
        public ResponseEntity<ResponseDTO<Page<NotificationResponseDTO>>> getNotifications(
                        ...
                        @RequestParam(required = false) Boolean isRead) { // TODO: Remove after auth, get from
                                                                          // SecurityContext
                try {
         ...
         * Tất cả user đã đăng nhập đều có thể subscribe
         */
         ...
         * CHỈ Admin hoặc Manager mới có quyền gửi broadcast
         */
         ...
         * network-error)
         * CHỈ Admin hoặc Manager mới có quyền xem thống kê
         */
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
         ...
         * CHỈ Admin hoặc Manager mới có quyền retry
         */
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
         ...
         * CHỈ Admin hoặc Manager mới có quyền cleanup
         */
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
