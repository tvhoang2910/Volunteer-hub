        ...
        >
            ...
            <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                    <span className="px-3 py-1 text-xs font-medium bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-full text-zinc-800 dark:text-zinc-200 shadow-sm">
                        {event.category}
                    </span>
                    {isRegistered && (
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${isRegistered
                    ...
                    <div className="w-8 h-8 rounded-full bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-zinc-400 group-hover:text-blue-600 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20 transition-colors">
                        <ArrowRight size={16} />
                    </div>
                </div>
            </div>
