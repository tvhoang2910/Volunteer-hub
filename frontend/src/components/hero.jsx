...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen lg:h-screen bg-black overflow-hidden">
      {/* Video Background */}
      <video
        autoPlay
        muted
      ...
      {/* Main Content */}
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-4 lg:px-6 py-20 lg:py-0">
        <motion.div
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl lg:text-7xl xl:text-8xl font-bold mb-6 lg:mb-8 leading-tight"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg lg:text-2xl text-gray-300 mb-12 lg:mb-16 font-light max-w-2xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:gap-6 mb-8 lg:mb-12"
          >
